...
const btnSubmit = document.getElementById("btnSubumit")
...
const errorMsg = "<div id='alert' class='divAlert error'><span>Por favor, preencha um campo para adicionar um item!</span></div>";
...
const showMessage = (hasItem) => {
    if (hasItem) {
        const successMsg = `<div id='alert' class='divAlert sucess'><span>${hasItem} adicionadocom sucesso!</span></div>`;
